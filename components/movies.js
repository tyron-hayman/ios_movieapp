                ...
                <ScrollView style={styles.scrollView}>
                    <ImageBackground source={{ uri : imgPath + movieDetails.poster_path }} style={styles.featuredMovie}>
                        ...
                        <View style={styles.movieDetailsTitle}>
                            <Text style={styles.featuredMovieTitle}>{movieDetails.original_title}</Text>
                        </View>
                        </LinearGradient>
                    </ImageBackground>
                    <View style={styles.movieDetails}>
                        ...
                        <Text style={styles.movieDetailsHeadinng}><Ionicons style={styles.navicons} name="timer" size={icoDimen.size} color={icoDimen.color} /> {movieDetails.runtime} MIN</Text>
